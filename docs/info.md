...
- Enc=0, Dec=1 : decode mode => the cleartext input is scrambled and output
- Enc=1, Dec=0 : encode mode => the scrambled input is restored to cleartext
- Enc=0, Dec=1 : loopback mode => encodes then decodes, cleartext is input and the delayed output must be identical.
